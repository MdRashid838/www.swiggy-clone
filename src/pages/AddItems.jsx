...
export default function AddItems({restaurant}) {
  console.log(restaurant, "all restaurant")
  console.log(restaurant.items, "all items")
  // console.log(restaurant, "all restaurant")
  const { id } = useParams();
  ...
  return (
    <div className="px-2 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {Array.isArray(restaurant.items) && restaurant.items.length > 0 && restaurant.items.map((item) => (
