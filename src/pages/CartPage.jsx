  ...
  return (
    <div>
      ...
      <div className='space-y-3'>
        {cart.items.map(i=> (
          <div key={i.menuItem} className='bg-white p-3 rounded flex justify-between items-center'>
            <div>
            ...
            <div className='text-right'>
              ...
              <button onClick={()=>dispatch(removeItem(i.menuItem))} className='text-sm text-red-600'>Remove</button>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className='mt-4 flex justify-between items-center'>
        ...
        <div className='flex gap-2'>
          <button onClick={()=>dispatch(clearCart())} className='px-3 py-1 border rounded'>Clear</button>
